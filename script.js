...
async function persistDelete(mod, id){
  try{
    ...
    if(error) console.error('Erro ao excluir de '+mod, error);
  }catch(e){ console.error('Falha ao excluir de '+mod, e); }
}
